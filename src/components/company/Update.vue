    ...
    <div class="container-fluid px-3 mt-5">
      <div class="row mb-3">
        <div class="col-6 d-flex justify-content-between ps-0">
          <div class="me-lg-3">
            <h5 class="form-title">Update Company</h5>
          </div>
        </div>
        ...
        <div class="card px-3 py-3 mb-3">
          <form role="form" @submit.prevent="handleSubmit($event)">
            <div class="row">
              <div class="col-lg-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="Please input text" id="code" name="code" class="form-control"
                         v-model="company.company_code" maxlength="6" disabled required/>
                </div>
              </div>
              <div class="col-lg-6 mb-3">
                <div class="form-group">
              ...
              <div class="col-lg-6 mb-3">
                <div class="form-group">
                  <label for="npwpPhoto">NPWP Photo</label>
              ...
              <div class="col-lg-6 mb-3">
                <div class="form-group">
                  <label for="siup">SIUP Number</label>
              ...
              <div class="col-lg-6 mb-3">
                <div class="form-group">
                  <label for="siupPhoto">SIUP Photo</label>
...
export default {
  ...
  methods: {
    ...
    getEmployees() {
      let loading = this.$loading.show();
      EmployeeService.getAll(this.company.id).then(response => {
        if (response.code === 200) {
    ...
    getCompany() {
      let loading = this.$loading.show();
      CompaniesService.getShow(utils.decrypt(this.$route.params.id)).then(response => {
        if (response.code === 200) {
    ...
    handleSubmit() {
      let loading = this.$loading.show();
      CompaniesService.postUpdate(this.company.id, this.company).then(response => {
        if (response.code === 200) {
          ...
          this.$swal.fire({
            icon: "success",
            title: "Success",
            text: "Company account has been updated",
          });
          router.back();
        } else {
          loading.hide();
