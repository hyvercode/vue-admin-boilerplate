          ...
          <div class="row d-block d-xl-flex align-items-center">
            ...
            <div class="col-12 col-xl-7 px-xl-0">
              <div class="d-none d-sm-block">
                <h2 class="h6 text-gray-400 mb-0">Ticket</h2>
                <h3 class="fw-extrabold mb-2">{{ ticketOverview.total_ticket }}</h3>
              </div>
        ...
        <div class="card-body">
          <div class="row d-block d-xl-flex align-items-center">
            <div
              ...
              <div class="d-sm-none">
                <h2 class="fw-extrabold h5">InProgress</h2>
                <h3 class="mb-1">$43,594</h3>
              </div>
            </div>
            <div class="col-12 col-xl-7 px-xl-0">
              <div class="d-none d-sm-block">
                <h2 class="h6 text-gray-400 mb-0">InProgress</h2>
                <h3 class="fw-extrabold mb-2">{{ ticketOverview.total_inprogress }}</h3>
              </div>
              <small class="d-flex align-items-center text-gray-500">
                Feb 1 - Apr 1,
                <svg class="icon icon-xxs text-gray-500 ms-2 me-1" fill="currentColor" viewBox="0 0 20 20"
        ...
        <div class="card-body">
          <div class="row d-block d-xl-flex align-items-center">
            <div
              ...
              <div class="d-sm-none">
                <h2 class="fw-extrabold h5">Backlog</h2>
                <h3 class="mb-1">50.88%</h3>
              </div>
            </div>
            <div class="col-12 col-xl-7 px-xl-0">
              <div class="d-none d-sm-block">
                <h2 class="h6 text-gray-400 mb-0">Backlog</h2>
                <h3 class="fw-extrabold mb-2">{{ ticketOverview.total_backlog }}</h3>
              </div>
        ...
        <div class="card-body">
          <div class="row d-block d-xl-flex align-items-center">
            <div
              ...
              <div class="d-sm-none">
                <h2 class="fw-extrabold h5">Done</h2>
                <h3 class="mb-1">50.88%</h3>
              </div>
            </div>
            <div class="col-12 col-xl-7 px-xl-0">
              <div class="d-none d-sm-block">
                <h2 class="h6 text-gray-400 mb-0">Done</h2>
                <h3 class="fw-extrabold mb-2">{{ ticketOverview.total_done }}</h3>
              </div>
              <small class="text-gray-500">
                Feb 1 - Apr 1
              </small>
...
export default {
  ...
  methods: {
    getTicketOverview() {
      ...
      DashboardService.getEticketOverview().then((response) => {
        if (response.code === 200) {
          this.ticketOverview = response.data;
          loading.hide();
        } else {
          loading.hide();
          this.$swal.fire("Error!", "ETicket" + response.message, "error");
        }
      });
    },}
}
