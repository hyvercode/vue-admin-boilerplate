    ...
    <div class="container-fluid px-3 mt-5">
      <div class="row mb-3">
        <div class="col-6 d-flex justify-content-between ps-0">
          <div class="me-lg-3">
            <h5 class="form-title">Update Employee</h5>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-6 mb-3">
                <div class="form-group">
                  ...
                  <select class="form-control" id="branch" name="branch" v-model="employee.branch_id" disabled>
...
export default {
  ...
  methods: {
    getEmployee() {
      ...
      EmployeeService.getShow(utils.decrypt(this.$route.params.id)).then(response => {
    ...
    handleSubmit() {
      let loading = this.$loading.show();
      EmployeeService.postUpdate(this.employee.id,this.employee).then(response => {
        if (response.code === 200) {
