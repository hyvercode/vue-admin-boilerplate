<template>
  <div class="container-fluid">
    <form-header title="Update Employee" />
    <div class="row">
...
export default {
  ...
  methods: {
    getEmployee() {
      ...
      EmployeeService.getShow(utils.decrypt(this.$route.query.id)).then(
        (response) => {
    ...
    getJobPosition() {
      let loading = this.$loading.show();
      JobpositionService.getAll().then((response) => {
        if (response.code === 200) {
    ...
    getJobTitle() {
      let loading = this.$loading.show();
      JobtitleService.getAll().then((response) => {
        if (response.code === 200) {
        ...
        (response) => {
          if (response.code === 200) {
            ...
            this.$swal.fire({
              icon: "success",
              title: "Success",
              text: "Employee account has been updated",
            });
            router.back();
          } else {
            loading.hide();
