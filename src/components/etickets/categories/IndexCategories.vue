<template>
  <div class="container-fluid">
    ...
    <b-modal id="m-jobposition" :title="isUpdate?'Update E-Ticket Categories':'Create E-Ticket Categories'" hide-footer>
...
export default {
  ...
  methods: {
    ...
    getPaginate(dateFrom, dateTo, searchBy, searchParam, limit, page) {
      ...
      let loading = this.$loading.show();
      ETicketCategoriesService.getPaginate(params).then((response) => {
        if (response.code === 200) {
